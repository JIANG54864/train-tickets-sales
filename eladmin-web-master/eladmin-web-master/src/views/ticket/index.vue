  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="座位类型" prop="seatType">
            <el-input v-model="form.seatType" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="是否售出" prop="isSold">
            <el-input v-model="form.isSold" style="width: 370px;" />
          </el-form-item>
        </el-form>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','ticket:edit','ticket:del'])" label="操作" width="150px" align="center">
...
<script>
import crudTicket from '@/api/ticket'
...
export default {
  ...
  cruds() {
    return CRUD({ title: '车票管理', url: 'api/ticket', idField: 'idticket', sort: 'idticket,desc', crudMethod: { ...crudTicket }})
  },
  data() {
    return {
      isSoldTypeOptions: [
